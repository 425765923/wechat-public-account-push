...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx0df866127366d09b',

  // 使用微信测试号时才需要填写：公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '58985f5b3a024646ab8a6e421aa096cd',
  ...
  USERS: [
    {
      ...
      id: 'o0Tgj5_0SSHr36lwa8_69uYg3Hsg',
      // 使用微信测试号：你想对他发送的模板消息的模板ID
      // 使用其他通道时，请填写 config/template-config.cjs 中某个想要使用的模板的id
      useTemplateId: '7RFcFPMh0-jD6ILQR3FHXfEweLkGbyredN4IS-exWSk',
      // 所在省份或城市，也可以不填
      province: '广东',
      // 所在城市或县区
      city: '深圳',
      ...
      openUrl: 'http://april-jia.com:701/',
      // 专属节日提醒，如果你在这里填写了节日提醒，就不会执行FESTIVALS的提醒了, 和FESTIVALS的配置方法相同，可以往下查看，我这里就不重复写了
      festivals: [
        // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
        {
          type: '*生日', name: '小可爱', year: '1994', date: '08-10',
        },
        {
          type: '*生日', name: '哥哥', year: '1996', date: '12-06',
        }
      ]
    },
//     {
...
//       // 使用微信测试号：扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
//       // 使用其他通道时，请严格按照各个通道的教程进行填写
//       id: 'o0Tgj539HnkB2Plyxaq2ndZu7QNk',
//       // 使用微信测试号：你想对他发送的模板消息的模板ID
//       // 使用其他通道时，请填写 config/template-config.cjs 中某个想要使用的模板的id
//       useTemplateId: '4tuXVEF61c5aa-yoAi0rVq-yiAbS-6nzI11ZPcD_nBw',
//       // 所在省份或城市，也可以不填
//       province: '广东',
//       // 所在城市或县区
//       city: '深圳',
...
//     }
  ...
  CALLBACK_TEMPLATE_ID: 'LfNB3uJaA0aowHb56f_SlhdSJiZalFRkaW8kX4vzaA8',
  ...
  FESTIVALS: [
    // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
    {
      type: '*生日', name: '嘉哥哥', year: '1996', date: '12-06', isShowAge: false,
    },
    {
      type: '*生日', name: '小可爱', year: '1994', date: '08-10', isShowAge: false
    }
    // 你可以不断按格式往下增加
    // ...
  ],
  ...
  CUSTOMIZED_DATE_LIST: [
    // 在一起的日子
    { keyword: 'love_day', date: '2022-07-01' }
  ],
